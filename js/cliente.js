...
window.$restologia.obtenerLibro = async function(hipervinculo, capitulo, versiculo) {try {const response = (await window.$restologia.cliente.get("books/" + hipervinculo));
